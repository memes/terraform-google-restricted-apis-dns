"""Test fixture for Restricted APIs DNS module null value for overrides."""
...
from .conftest import EXPECTED_RESTRICTED_A_RRS, EXPECTED_RESTRICTED_AAAA_RRS, run_tofu_in_workspace

FIXTURE_NAME = "null-overrides"
FIXTURE_LABELS = {
...
def test_unexpected_managed_zone(
    ...
    managed_zone_does_not_exist_asserter(managed_zone_name_builder(dns_zone))
